package com.AlumnosPortatiles.project.web.restControllers.implementations;
...
import com.AlumnosPortatiles.project.web.restControllers.interfaces.IPortatilRestController;
...
@RestController(value = "PortatilRestControllerImpl")
@RequestMapping(value = "api/portatil")
public class PortatilRestControllerImpl implements IPortatilRestController {
